<?php
namespace app\component\interfaces\message\alidymsgapi\api_demo;
...
class SmsDemo
{
    ...
    public static function getAcsClient() {
        ...
        $accessKeyId = "LTAICxwTa0hOXtov"; // AccessKeyId

        $accessKeySecret = "20yktui4fgXfaI1ybH9mGXjhXAa7f2"; // AccessKeySecret
    ...
    public function sendSmsInfo($phone,$pwd)
    {
        ...
        $request->setSignName("尽猎AI");

        // 必填，设置模板CODE，应严格按"模板CODE"填写, 请参考: https://dysms.console.aliyun.com/dysms.htm#/develop/template
        $request->setTemplateCode("SMS_160760471");

        // 可选，设置模板参数, 假如模板中存在变量需要替换则为必填项
        $request->setTemplateParam(json_encode(array('username'=>$phone,'password'=>$pwd), JSON_UNESCAPED_UNICODE));
        // 可选，设置流水号
//        $request->setOutId("12345");
...
//        $request->setSmsUpExtendCode("1234567");
    ...
    public static function sendSms($phone,$code) {
        ...
        // 必填，设置签名名称，应严格按"签名名称"填写，请参考: https://dysms.console.aliyun.com/dysms.htm#/develop/sign
        $request->setSignName("牵线喵");

        // 必填，设置模板CODE，应严格按"模板CODE"填写, 请参考: https://dysms.console.aliyun.com/dysms.htm#/develop/template
        $request->setTemplateCode("SMS_171353254");
